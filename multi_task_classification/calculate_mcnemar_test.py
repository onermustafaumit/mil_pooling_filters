...
folder_path_list = [ 
"test_metrics/2020_11_28__14_10_14__3000/test",
"test_metrics/2020_05_23__15_50_06__3080/test",
"test_metrics/2020_05_17__02_26_00__900/test",
"test_metrics/2020_05_17__15_29_39__380/test",
]
...
for i in range(num_filters):
	...
	predicted1 = np.asarray(data1[:,3],dtype=int)
	...
	for j in range(i+1,num_filters):
		...
		predicted2 = np.asarray(data2[:,3],dtype=int)
...
p_values_filename = 'test_metrics/p_values_normal.txt'
...
fig.tight_layout()
fig_filename = 'test_metrics/p_values_color_coded_normal.png'
...
fig.tight_layout()
fig_filename = 'test_metrics/p_values_normal.png'
fig.savefig(fig_filename, dpi=200)
...
for i in range(num_filters):
	...
	file1 = '{}/image_predictions_mpp.txt'.format(folder1)
	data1 = np.loadtxt(file1, delimiter='\t', comments='#',dtype=str)
	truth1 = np.asarray(data1[:,2],dtype=int)
	predicted1 = np.asarray(data1[:,4],dtype=int)
	...
	for j in range(i+1,num_filters):
		...
		file2 = '{}/image_predictions_mpp.txt'.format(folder2)
		data2 = np.loadtxt(file2, delimiter='\t', comments='#',dtype=str)
		truth2 = np.asarray(data2[:,2],dtype=int)
		predicted2 = np.asarray(data2[:,4],dtype=int)
...
p_values_filename = 'test_metrics/p_values_metastases.txt'
np.savetxt(p_values_filename, p_values_arr, delimiter='\t', comments='# ', header='\t'.join(mil_filter_list)) #fmt='%.4f',
...
fig.tight_layout()
fig_filename = 'test_metrics/p_values_color_coded_metastases.png'
fig.savefig(fig_filename, dpi=200)
...
fig.tight_layout()
fig_filename = 'test_metrics/p_values_metastases.png'
fig.savefig(fig_filename, dpi=200)
