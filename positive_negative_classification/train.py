...
parser.add_argument('--save_interval', default=20, type=int, help='Model save interval (default: 1000)', dest='save_interval')
...
with open(metrics_file,'w') as f_metric_file:
	...
	f_metric_file.write('# epoch\ttraining_acc\ttraining_loss\tvalidation_acc\tvalidation_loss\n')
